...
func main() {
	...
	*/
	...
	/*
	Importantly, we use the flag.Parse() function to parse the command-line flag.This reads in the command-line flag value and assigns it to the addrvariable. You need to call this *before* you use the addr variableotherwise it will always contain the default value of ":4000". If any errors are encountered during parsing the application will be terminated.
	*/
	flag.Parse()
